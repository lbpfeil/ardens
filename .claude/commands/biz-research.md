...
2. Se o arquivo **não existir**, informe ao usuário: "O contexto de negócio ainda não foi criado. Rode `/biz-context` primeiro para que eu entenda a empresa antes de pesquisar." **Não prossiga sem o arquivo.**
...
**SEMPRE faça 2-4 perguntas curtas antes de pesquisar**, usando a ferramenta AskUserQuestion. As perguntas devem:
...
Após as respostas, lance **3-4 agentes de pesquisa em paralelo** usando a ferramenta Task (subagent_type: general-purpose). Cada agente deve:
- Receber o contexto relevante do CONTEXT.md (não o arquivo inteiro — apenas o que importa para o ângulo)
- Pesquisar um ângulo diferente do tema usando WebSearch e WebFetch
- Retornar descobertas estruturadas com fontes
- Focar em informação acionável para o estágio atual do Arden (extraído do CONTEXT.md)

Distribua os agentes por ângulos complementares. Exemplo para "pricing":
- Agente 1: Benchmarks de pricing de SaaS para construção civil no Brasil
- Agente 2: Modelos de precificação por usuário vs. por obra vs. por unidade
- Agente 3: Como concorrentes do Arden (listados no CONTEXT.md) precificam
- Agente 4: Estratégias de pricing para SaaS B2B no estágio do Arden (extraído do CONTEXT.md)
...
### [Ângulo 1]
[Descobertas do agente 1, com dados e fontes]

### [Ângulo 2]
[Descobertas do agente 2, com dados e fontes]

### [Ângulo 3]
[Descobertas do agente 3, com dados e fontes]
...
- Se não houver $ARGUMENTS e a conversa não deixar claro o tema, pergunte ao usuário
